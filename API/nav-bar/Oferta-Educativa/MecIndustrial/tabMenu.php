            ...
            $this->HTML = <<< HTML
                <div class="article_TabNav">
                    ...
                    <div class="article_img article_1_img">
                        <img src="/API/nav-bar/Oferta-Educativa/MecIndustrial/recursos/Banner - Mecanica Industrial.png" alt="">
                        <hr>
                    </div>
                    ...
                    <ul class="article_TabContent">
                        <li>
                            ...
                            <div class="article_TabContainer">
                                ...
                                <p class="article_text article_1_text">
                                    La carrera de Mecánica Industrial ofrece las competencias profesionales que permiten al estudiante dar mantenimiento a los sistemas de 
                                    transmisión de potencia utilizando las máquinas herramientas convencionales, de control numérico, máquinas de soldar con arco eléctrico y 
                                    oxigas auxiliándose de los procesos de ajuste de piezas mecánicas.
                                </p>
                                <p class="article_text article_1_text">
                                ...
                                <p class="article_text article_1_text">
                                    ...
                                    competencias de soldar y ajustar piezas mecánicas, maquinar piezas mecánicas en taladro y torno, maquinar piezas mecánicas en fresadora, 
                                    rectificadora y cepillo, maquinar piezas mecánicas por CNC y mantener sistemas de transmisión de potencia.
                                </p>
                                <p class="article_text article_1_text">
                        ...
                        <li>
                            ...
                            <div class="article_TabContainer">
                                ...
                                correspondientes al Técnico en mecánica industrial:
                                </p>
                                <p class="article_text article_1_text">
                        ...
                        <li>
                            ...
                            <div class="article_TabContainer">
                                <div class="article_img article_1_img">
                                    <img src="/API/nav-bar/Oferta-Educativa/MecIndustrial/recursos/Estructura Curricular Mecanica Industrial.png" alt="">
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="article_TabContainer">
                                <div class="article_img article_1_img">
                                    <img src="/API/nav-bar/Oferta-Educativa/MecIndustrial/recursos/Competencias Profesionales Mecanica Industrial.png" alt="">
                                </div>
                            </div>
                        </li>
                        <li>
                                ...
                                <table class="article_table  {$this->theme}_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="/API/nav-bar/Oferta-Educativa/MecIndustrial/recursos/Mecanica_Industrial.pdf" target="_blank"><i class="fa-solid fa-download"></i> Descargar</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
