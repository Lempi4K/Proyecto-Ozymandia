            ...
            $this->HTML = <<< HTML
                <div class="article_TabNav">
                    ...
                    <div class="article_img article_1_img">
                        <img src="/OPI/nav-bar/Oferta-Educativa/Programacion/recursos/Banner - Programacion.png" alt="">
                        <hr>
                    </div>
                    ...
                    <ul class="article_TabContent">
                        <li>
                            ...
                            <div class="article_TabContainer">
                                ...
                                <p class="article_text article_1_text">
                                    La carrera de Técnico en programación ofrece las competencias profesionales que permiten al estudiante realizar actividades dirigidas 
                                    a: analizar, diseñar, desarrollar , instalar y mantener software de aplicación tomando como base los requerimientos del usuario.
                                </p>
                                <p class="article_text article_1_text">
                                ...
                                <p class="article_text article_1_text">
                                    Permite al técnico incorporarse al ámbito laboral en diversos sitios de inserción como: Edición de Software y edición de software integrada 
                                    con la reproducción, Servicios de diseño de sistemas de cómputo y servicios relacionados, Escuelas de computación del sector privado, Escuelas 
                                    de computación del sector publico, Edición y difusión de contenido exclusivamente a través de Internet y Servicios de búsqueda en la red
                                </p>
                                <p class="article_text article_1_text">
                        ...
                        <li>
                            ...
                            <div class="article_TabContainer">
                                ...
                                <p class="article_text article_1_text">
                                    La formación que ofrece la carrera de Técnico en programación permite al egresado, a través de la articulación de saberes de 
                                    diversos campos, realizar actividades dirigidas a:
                                </p>
                                <p class="article_text article_1_text">
                                    • Instalación y desarrollo de software de aplicación utilizando programación estructurada y orientada a objetos en ambientes 
                                    web y móviles, con almacenamiento persistente de datos.
                                    <br>
                                    • Configuración y administración de plataformas e-learning.
                                    <br>
                                    • Configuración y administración de plataformas e-commerce.
                                <p class="article_text article_1_text">
