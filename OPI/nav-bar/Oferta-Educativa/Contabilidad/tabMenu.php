            ...
            $this->HTML = <<< HTML
                <div class="article_TabNav">
                    ...
                    <div class="article_img article_1_img">
                        <img src="/OPI/nav-bar/Oferta-Educativa/Contabilidad/recursos/Banner - Contabilidad.png" alt="">
                        <hr>
                    </div>
                    ...
                    <ul class="article_TabContent">
                        <li>
                            ...
                            <div class="article_TabContainer">
                                ...
                                <p class="article_text article_1_text">
                                    La carrera de Técnico en contabilidad ofrece las competencias profesionales que permiten al estudiante registrar operaciones 
                                    contables de empresas comerciales y de servicios operando los procesos contables a través de un sistema electrónico, así como 
                                    registrar operaciones contables de una entidad fabril, determinar contribuciones y asistir en actividades de auditoría.
                                </p>
                                <p class="article_text article_1_text">
                                ...
                                <p class="article_text article_1_text">
                                    La formación profesional se inicia en el segundo semestre y se concluye en el sexto semestre, desarrollando en este lapso de 
                                    tiempo las competencias para registrar operaciones contables de empresas comerciales y de servicios, operar los procesos contables 
                                    dentro de un sistema electrónico, registrar operaciones contables de una entidad fabril, determinar las contribuciones fiscales de 
                                    personas físicas y morales y asistir en actividades de auditoría de una entidad.
                                </p>
                                <p class="article_text article_1_text">
                        ...
                        <li>
                            ...
                            <div class="article_TabContainer">
                                ...
                                <p class="article_text article_1_text">
                                    ...
                                    profesionales, correspondientes al Técnico en contabilidad:
                                </p>
                                <p class="article_text article_1_text">
                                    ...
                                    <br>
                                    • Determina las contribuciones fiscales de personas físicas y morales y asiste en actividades de auditoría de una entidad.
                                </p>
                                <p class="article_text article_1_text">
                        ...
                        <li>
                            ...
                            <div class="article_TabContainer">
                                <div class="article_img article_1_img">
                                    <img src="/API/nav-bar/Oferta-Educativa/Contabilidad/recursos/Estructura Curricular Contabilidad.png" alt="">
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="article_TabContainer">
                                <div class="article_img article_1_img">
                                    <img src="/API/nav-bar/Oferta-Educativa/Contabilidad/recursos/Competencias Profesionales Contabilidad.png" alt="">
                                </div>
                            </div>
                        </li>
                        <li>
                                ...
                                <table class="article_table  {$this->theme}_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="/API/nav-bar/Oferta-Educativa/Contabilidad/recursos/Contabilidad.pdf" target="_blank"><i class="fa-solid fa-download"></i> Descargar</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
