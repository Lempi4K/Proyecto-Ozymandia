                    ...
                    <ul class="article_TabContent">
                        <li>
                            ...
                            <div class="article_TabContainer">
                                ...
                                <p class="article_text article_1_text">
                                    La carrera de Técnico en electricidad ofrece las competencias profesionales que permiten al estudiante sustentar la demanda de ocupación 
                                    de Técnicos Electricistas en el sector productivo y de servicios, capaz de diseñar y realizar instalaciones eléctricas residenciales y 
                                    comerciales, así como proporcionar mantenimiento a máquinas eléctricas.
                                </p>
                                <p class="article_text article_1_text">
                                ...
                                <p class="article_text article_1_text">
                                    ...
                                    competencias: Desarrolla instalaciones eléctricas residenciales y comerciales, mantiene los motores y generadores de CA y CC, mantiene 
                                    en operación los circuitos de control electromagnético y electrónico, mantiene los sistemas de iluminación y de energía renovable y 
                        ...
                        <li>
                            ...
                            <div class="article_TabContainer">
                                ...
                                correspondientes al Técnico en electricidad.
                                </p>
                                <p class="article_text article_1_text">
                        ...
                        <li>
                            ...
                            <div class="article_TabContainer">
                                <div class="article_img article_1_img">
                                    <img src="/API/nav-bar/Oferta-Educativa/Electricidad/recursos/Estructura Curricular Electricidad.png" alt="">
                                </div>
                            </div>
                        </li>
                        <li>
                            ...
                            <div class="article_TabContainer">
                                <div class="article_img article_1_img">
                                    <img src="/API/nav-bar/Oferta-Educativa/Electricidad/recursos/Competencias Profesionales Electricidad.png" alt="">
                                </div>
                            </div>
                        </li>
                        <li>
                                ...
                                <table class="article_table  {$this->theme}_table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><a href="/API/nav-bar/Oferta-Educativa/Electricidad/recursos/Electricidad.pdf" target="_blank"><i class="fa-solid fa-download"></i> Descargar</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
